-- ============================================================
-- V4__seed_products_and_orders.sql
-- Flyway Migration - Categories, Products & Orders Seed Data
-- ============================================================
...
-- Teddy Bears — Partner 3 (Lucky Gifts)
INSERT INTO products (partner_id, name, price, stock_quantity, sku, image_url, category_id, is_active) VALUES
...
-- Chocolates — Partner 3 (Lucky Gifts)
INSERT INTO products (partner_id, name, price, stock_quantity, sku, image_url, category_id, is_active) VALUES
...
-- ============================================================
-- 3. Orders — items.sql from original
-- ============================================================
...
-- ============================================================
-- 4. Orders — Graph / Analytics data (data.sql from original)
-- ============================================================
...
(9,  2, 'CONFIRMED',  7200.00,  DATE_SUB(NOW(), INTERVAL 2 DAY), 'Negombo'),
