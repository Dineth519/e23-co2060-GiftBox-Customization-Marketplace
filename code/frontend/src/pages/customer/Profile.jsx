  ...
  useEffect(() => {
    async function fetchData() {
      ...
      try {
        ...
        try {
          const statsRes = await fetch(`http://localhost:8080/api/orders/customer/${userId}/summary`, {
            headers: { 'Authorization': `Bearer ${localStorage.getItem('accessToken')}` }
          });
          if (statsRes.ok) {
      ...
      <div className="pf-details-grid">
        ...
        <div className="pf-detail-card">
          <div className="pf-detail-card-head">
            ...
            <button className="pf-detail-manage" onClick={() => navigate('/order-history')}>View All</button>
          </div>
